...
function getCellCoordinatesFromPosition(x, y) {
    ...
    // 그리드 내 상대 위치 계산
    var relativeX = x - gridRect.left - GRID_PADDING; // 그리드 패딩 고려
    var relativeY = y - gridRect.top - GRID_PADDING;
    // 셀 좌표 계산
    var col = Math.floor(relativeX / (CELL_SIZE + GRID_GAP)); // 그리드 갭 고려
    var row = Math.floor(relativeY / (CELL_SIZE + GRID_GAP));
    // 유효한 범위로 제한
